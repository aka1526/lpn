                ...
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                    <div class="card  box-shadow-0 ">
                        <div class="card-header">
                            <h4 class="card-title mb-1">Courses Slide  Title</h4>
                        ...
                        @endif
                            <form id="frm" name="frm" action="{{ route('course.courses_slide')}}" method="POST" >
                                @csrf
                                <input type="hidden" name="pageheader_uid" id="pageheader_uid"  value="{{ isset($courses_slide->pageheader_uid) ? $courses_slide->pageheader_uid :''}}" >
 
                                <div class="">
                                    
                                    <div class="form-group">
                                        <label for="pageheader_title"> Title</label>
                                        <input type="text" class="form-control" id="pageheader_title" name="pageheader_title" value="{{ isset($courses_slide->pageheader_title) ? $courses_slide->pageheader_title :''}}" placeholder="Enter Title">
                                    </div>
                                    <div class="form-group">
                                        <label for="pageheader_header">Main</label>
                                        <input type="text" class="form-control" id="pageheader_header" name="pageheader_header" value="{{ isset($courses_slide->pageheader_header) ? $courses_slide->pageheader_header :''}}"  placeholder="Enter Main">
                                    </div>
                                    <div class="form-group">
                                        <label for="pageheader_detail">Detail</label>
                                        <textarea class="form-control" id="pageheader_detail"  name="pageheader_detail" placeholder="Enter Detail" rows="3">{{ isset($courses_slide->pageheader_detail) ? $courses_slide->pageheader_detail :''}}</textarea>
                                    </div>
