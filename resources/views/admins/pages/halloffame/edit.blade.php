    ...
    <div class="main-content horizontal-content ">
        ...
        <div class="container">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data"
                action="{{ route('halloffame.update') }}">
                @csrf
                <input type="hidden" id="hof_uid" name="hof_uid" value="{{ $halloffames->hof_uid }}">
                <input type="hidden" id="hof_index" name="hof_index" value="{{ $halloffames->hof_index }}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mt-3 row row-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" id="hof_title" name="hof_title"
                                                value="{{ $halloffames->hof_title }}" placeholder="Enter Title">
                                        </div>
                                    </div>
                                ...
                                <div class="mt-3 row">
                                    <div class="col-md-6">
                                        <img class="card-img-top w-100 "
                                            ...
                                            src="{{ '/images/halloffame/thumbnails/' . $halloffames->hof_img }}" alt="">
                                    </div>
                                </div>
                                <div class="mt-3 row">
                                    <div class="col">
                                        <label class="form-label">File Browser Image <span
                                ...
                                <div class="row row-sm mg-t-20">
                                    <div class="col-lg">
                                        <textarea id="hof_content" name="hof_content" class="form-control"
                                            placeholder="content" rows="10" required>
                                                    {!! $halloffames->hof_content !!}
                                                </textarea>
                                    </div>
