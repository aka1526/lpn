                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="type" name="type">
                                          ...
                                          <option value="MEMBERS" {{ Request::get('type')=='MEMBERS' ? 'selected' :'' }}>Members</option>
                                          <option value="STUDENTS" {{ Request::get('type')=='STUDENTS' ? 'selected' :'' }}>Students</option>
                                          <option value="TEACHERS" {{ Request::get('type')=='TEACHERS' ? 'selected' :'' }}>Teachers</option>
