                ...
                <div class="col-xl-12">
                    <div class="card  box-shadow-0 ">
                        <div class="card-header bg-primary text-white">
                            <h4 class="card-title mb-1 text-white">Page :: {{ $aboutus->aboutus_name }} </h4>
                            
                        </div>
                        <div class="card-body pt-10">
                            <form id="frm" action="{{ route('aboutus.update')}}" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="aboutus_uid" name="aboutus_uid" value="{{ $aboutus->aboutus_uid}}"> 
                                @csrf
                                <div class="">
                                    <div class="row row-sm">
                                        <div class="col-md-2 col-sm-2 mg-t-10 mg-lg-t-0">
                                            <label for="aboutus_name">No.</label>
											<input type="number" class="form-control" id="aboutus_index" name="aboutus_index" value="{{ $aboutus->aboutus_index}}" min="1" max="20"  >
										</div>
										<div class="col-lg mg-t-10 mg-lg-t-0">
                                            <label for="aboutus_name">Page Name</label>
                                            <input type="text" class="form-control" id="aboutus_name" name="aboutus_name" value="{{ $aboutus->aboutus_name}}" placeholder="Enter Page name" required>
										</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="aboutus_header" name="aboutus_header" value="{{ $aboutus->aboutus_header}}"  placeholder="Enter Header Text">
                                    </div>
                                    <div class="row row-sm mg-t-20">
                                       
										<div class="col-lg-12 col-md-12 col-sm-12">
                                            <label for="aboutus_desc">body</label>
											<textarea class="form-control" id="aboutus_desc" 
                                            name="aboutus_desc" placeholder="body" rows="30" required>
                                    ...
                                    <div class="row row-sm mg-t-20">
                                        {{-- <div class="col-lg-5 col-6 mg-t-5 mg-lg-t-0">
                                            ...
                                            <input type="text" class="form-control" id="aboutus_url" name="aboutus_url" value="{{ $aboutus->aboutus_url}}" placeholder="Enter Url name" >
										</div> --}}
                                        ...
                                        <div class="col-lg-9">
                                            <div class="course-details-tab-area">
                                               <div class="course-details-main-img">
                                                  <img src="{{ '/images/aboutus/'.$aboutus->aboutus_url .'/'. $aboutus->aboutus_img }}" alt="">
                                               </div>
