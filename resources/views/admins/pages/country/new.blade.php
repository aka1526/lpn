...
@section('css')
    ...
    <link href="{{ asset('adminpage/assets/plugins/select2/css/select2.min.css') }}" rel="stylesheet">
		...
		<link href="{{ asset('adminpage/assets/plugins/amazeui-datetimepicker/css/amazeui.datetimepicker.css') }}" rel="stylesheet">
		<link href="{{ asset('adminpage/assets/plugins/jquery-simple-datetimepicker/jquery.simple-dtpicker.css') }}" rel="stylesheet">
                ...
                <div class="col-xl-12">
                    <div class="card  box-shadow-0 ">
                        <div class="card-header bg-primary text-white">
                            <h4 class="card-title mb-1 text-white">new Country </h4>
                            
                        </div>
                        <div class="card-body pt-10">
                            <form id="frm" action="{{ route('country.add')}}" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="country_uid" name="country_uid" value=""> 
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="">
                                    <div class="row row-sm">
                                        <div class="col-md-2 col-sm-2 mg-t-10 mg-lg-t-0">
											...
											<input type="text" class="form-control" id="country_code" name="country_code" value=""  placeholder="Enter code 3 d" >
										</div>
                                        <div class="col-md-2 col-sm-2 mg-t-10 mg-lg-t-0">
                                            <label for="aboutus_name">Country Code 3d</label>
											<input type="text" class="form-control" id="country_code3" name="country_code3" value=""  placeholder="Enter code 2d" >
										</div>

                                        <div class="col-lg mg-t-10 mg-lg-t-0">
                                            <label for="aboutus_name">Country Name</label>
                                            <input type="text" class="form-control" id="country_name" name="country_name" value="" placeholder="Enter country name" required>
										</div>
                                    </div>
