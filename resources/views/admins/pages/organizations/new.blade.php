                                ...
                                <div class="pl-0">
                                    <div class="main-profile-overview ">
                                        <div class="text-center main-img ">
                                            <img alt="" src="/assets/img/no-logo.png" />
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" id="org_www"
                                                        name="org_www" placeholder="www" value="">
                                                </div>
                                            </div>
                                            <div class="media">
                                                <div class="media-icon bg-primary-transparent text-primary">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control form-control-sm" id="org_name"
                                                        name="org_name" placeholder="org Name" value="" required>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control form-control-sm" id="org_name_teachers"
                                                        name="org_name_teachers" placeholder="Teachers" value=""  >
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="date" class="form-control form-control-sm" id="org_date_register"
                                                        name="org_date_register" placeholder="Register Date"  required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="email" class="form-control form-control-sm" id="org_email"
                                                        name="org_email " placeholder="email@email.com" value="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea class="form-control" id="org_address" name="org_address"
                                                        rows="3" placeholder="San Francisco, CA"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
