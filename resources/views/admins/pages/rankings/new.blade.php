...
@section('content')
    ...
    <div class="main-content horizontal-content ">
        ...
        <div class="container">
            ...
            <!-- row -->
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{ route('rankings.add') }}">
                @csrf
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="rankings_weight"
                                                        name="rankings_weight" value="" placeholder="Cruiserweight">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="rankings_weight_desc"
                                                        name="rankings_weight_desc" value=""
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="world_vacant"
                                                        name="world_vacant" value="" placeholder="Enter name">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="world_won_title"
                                                        name="world_won_title" value="" placeholder="July 24, 2021">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="world_last_defense"
                                                        name="world_last_defense" value="" placeholder="Enter name">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="international_vacant"
                                                        name="international_vacant" value="" placeholder="July 24, 2021">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="international_won_title"
                                                        name="international_won_title" value="" placeholder="July 24, 2021">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group ">
