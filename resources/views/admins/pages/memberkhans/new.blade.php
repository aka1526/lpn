                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label class="form-label">New Certificate</label>
                                                </div>
                                                <div class="col-md-7">
                                                    {{-- <h4>Certificate </h4> --}}
                                                    <input type="text" class="form-control form-control-sm"
                                                        id="certificate_no" name="certificate_no"
                                                        placeholder="Certificate no." value="PLN21/000" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label class="form-label">New Khan</label>
                                                </div>
                                                <div id="html" class="col-md-7">
                                                    {{-- <select class="form-control select2 khan_uid" id="new_khan" name="new_khan">
                                                        @foreach ($khans as $item)
                                                            <option value="{{ $item->khan_index }}">
                                                                {{ $item->khan_name }}</option>
                                                        @endforeach
...
@section('adminjs')
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#member_uid', function() {
            let uid = $(this).val();
            var url = "/pageadmin/memberkhans/get";
            $.ajax({
                type: "get",
                url: url,
                data: {
