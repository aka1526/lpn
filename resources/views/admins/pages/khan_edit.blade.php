                ...
                <div class="col-xl-12">
                    <div class="card  box-shadow-0 ">
                        ...
                        <div class="card-body pt-10">
                            <form id="frm" action="{{ route('khans.update')}}" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="khan_uid" name="khan_uid" value="{{ $khans->khan_uid }}"> 
                                @csrf
                                ...
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="khan_index">KHAN NO.{{ $khans->khan_index }}</label>
                                                <input type="number" class="form-control" id="khan_index" name="khan_index"
                                               max="30" min="1"  placeholder="Khan No " value="{{ $khans->khan_index }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group ">
                                                        ...
                                                        <select class="form-control select2" id="khan_group" name="khan_group">
                                                            <option value="STUDENTS" {{ $khans->khan_group =="STUDENTS" ? 'selected' : '' }}>STUDENTS</option>
                                                            <option value="TEACHERS" {{ $khans->khan_group =="TEACHERS" ? 'selected' : '' }}>TEACHERS</option>
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="khan_name" name="khan_name" 
                                                value="{{ $khans->khan_name }}"
                                                placeholder="Khan name" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row row-sm mg-t-20">
										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											...
											<textarea class="form-control" id="khan_desc" name="khan_desc" placeholder="body" rows="5" required>
                                               {!! $khans->khan_desc !!}
                                            </textarea>
										</div>
