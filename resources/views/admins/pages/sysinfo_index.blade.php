                            ...
                            <form id="frm" name="frm" action="{{ route('sysinfo.add') }}" method="POST">
                                ...
                                <div class="">
                                    <div class="row row-sm mg-b-10">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_name"
                                                    name="sys_name"
                                    ...
                                    <div class="row row-sm mg-b-10">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_country"
                                                    name="sys_country"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_email1"
                                                    name="sys_email1"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_email2"
                                                    name="sys_email2"
                                    ...
                                    <div class="row row-sm mg-b-10">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_phone1"
                                                    name="sys_phone1"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_phone2"
                                                    name="sys_phone2"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_openday"
                                                    name="sys_openday"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_openhour"
                                                    name="sys_openhour"
                                    ...
                                    <div class="row row-sm mg-b-10">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="sys_facebook"><i class="fab fa-facebook-square"></i>  Facebook</label>
                                                <input type="text" class="form-control" id="sys_facebook"
                                                    name="sys_facebook"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_twitter"
                                                    name="sys_twitter"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_youtube"
                                                    name="sys_youtube"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="intragram"><i class="typcn typcn-social-instagram"></i>  Intragram</label>
                                                <input type="text" class="form-control" id="intragram"
                                                    name="intragram"
                                    ...
                                    <div class="row row-sm mg-b-10">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="sys_googlemap_lat"> <i class="fa fa-map-marker"></i>  Googlemap-latitude</label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="sys_googlemap_lon"><i class="fa fa-map-marker"></i>  Googlemap-longitude</label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="sys_googlemap_zoom"><i class="fa fa-search-plus"></i>  Map-Zoom</label>
                                    ...
                                    <div class="row row-sm mg-b-10">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sys_slogan"
                                                    name="sys_slogan"
