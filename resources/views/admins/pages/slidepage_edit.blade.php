...
@section('content')
    ...
    <div class="main-content horizontal-content  ">
        ...
        <div class="container">
            ...
            <!-- breadcrumb -->
            <!-- container opened -->
 <form id="frm" action="{{ route('slidepage.update')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <input type="hidden" id="slidepages_uid" name="slidepages_uid"  value="{{ $uid }}">
            ...
            <div class="row row-sm">
                ...
                <div class="col-xl-12">
                            ...
                            <div class="col-3">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input type="number" class="form-control" id="slidepages_index" name="slidepages_index"
                                      min="1" value="{{ $slidepage->slidepages_index }}"  placeholder="No."  >
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="form-group ">
                                    ...
                                    value="{{ $slidepage->slidepages_headline }}" placeholder="Enter Top Header ">
                                </div>
                            </div>
                         ...
                         <div class="row row-sm">
                            ...
                            <div class="col-12">
                                <div class="form-group ">
                                    ...
                                    value="{{ $slidepage->slidepages_header }}" 
                        ...
                        <div class="row row-sm">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group ">
                                    ...
                                    value="{{ $slidepage->slidepages_link }}"  placeholder="Enter Link  url">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-4">
                                <div class="form-group ">
                                    ...
                                    <select class="form-control select2-no-search" id="slidepages_status" name="slidepages_status">
                                        ...
                                        <option value="Y" {{ $slidepage->slidepages_status =='Y' ? 'selected' :'' }} >Enable</option>
                                        <option value="N" {{ $slidepage->slidepages_status =='N' ? 'selected' :'' }} >Disable</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="btn-save" class="btn ripple btn-primary ">Save changes</button>
