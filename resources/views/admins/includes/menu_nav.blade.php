            ...
            <div class="horizontal-mainwrapper container clearfix">
                ...
                <nav class="horizontalMenu clearfix">
                    <ul class="horizontalMenu-list">
                        ...
                        <li aria-haspopup="true"><a href="{{ route('course.index')}}" class="">
                            <svg
                                xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                                <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                    ...
                    <li aria-haspopup="true"><a href="{{ route('slidepage.index')}}" class="">
                        <svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                        ...
                        <li aria-haspopup="true"><a href="widgets.html" class="">
                            <svg
                                ...
                                <ul class="sub-menu">
                                <li aria-haspopup="true"><a href="{{ route('admin.user')}}" class="slide-item">Staff List</a></li>
                                <li aria-haspopup="true"><a href="{{ route('menu.index')}}" class="slide-item">Menu List</a></li>
