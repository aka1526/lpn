            ...
            <div class="container clearfix horizontal-mainwrapper">
                ...
                <nav class="clearfix horizontalMenu">
                    <ul class="horizontalMenu-list">
                        ...
                        <li aria-haspopup="true"><a href="/pageadmin" class="">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                    <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        <li aria-haspopup="true"><a href="#" class="sub-icon">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li aria-haspopup="true"><a href="{{ route('course.home') }}" class="slide-item">
                                    Courses Title</a></li>
                                <li aria-haspopup="true"><a href="{{ route('course.index') }}" class="slide-item">
                                    Courses List</a></li>
                        ...
                        <li aria-haspopup="true"><a href="{{ route('aboutus.index') }}" class="">
                            <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                                <path d="M0 0h24v24H0V0z" fill="none" />
                                <path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
                                <path
