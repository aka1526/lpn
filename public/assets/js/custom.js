...
(function() {
    ...
    if (window.matchMedia('(min-width: 992px)').matches) {
        //  $('.yl-header-menu .active').removeClass('show');
        //$('.yl-header-menu-wrap .active').removeClass('show');
    }
    // Shows header dropdown while hiding others
    ...
    // $('.yl-header-cart-login').click(function() {

    //     $('.yl-top-cart-login').removeClass("show");
