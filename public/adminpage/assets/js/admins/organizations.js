...
$(document).on('click', '.btn-renew', function() {
    ...
    var uid = $(this).data('uid');
    var url = "/pageadmin/members/organizations/renew";
...
$('.btn-disable').on('click', function() {
    ...
    var url = "/pageadmin/members/organizations/updatestatus";
...
$('.btn-delete').on('click', function() {
    ...
    var uid = $(this).data('uid');
    var url = "/pageadmin/members/organizations/delete";
...
$(document).on('click', '#renew', function(e) {
    e.preventDefault();
    var uid = $(this).data('uid');
    var url = "/pageadmin/members/organizations/get";
    var effect = $(this).attr('data-effect');
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.success) {
                ...
                var course = data.data;
                $("#org_uid").val(course.org_uid);
                $("#org_name").val(course.org_name);

                $("#org_date_validate").val(course.org_date_validate);
                $("#org_date_exp").val(course.org_date_exp);
